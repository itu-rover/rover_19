...
#Used for controlling 6-axis robotic arm with forward kinematics by using Logitech joystick. Reads encoder data, changes it (increases or decreases joint states) according to joystick command and adds gripper command.
