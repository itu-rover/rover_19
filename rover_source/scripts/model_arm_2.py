...
# Used for controlling robotic arm in simulation via model arm. Subscribes Arduino rosserial topic "/chatter", takes joint state values of model arm and sends them individual controllers as command
...
class joint_states(object):
	def __init__(self):
		...
		rospy.Subscriber("/chatter", String, self.potentiometer_callback)  #subscribes rosserial topic
